...
import { MessageCircle, X, Send, Phone, Mail, Square } from 'lucide-react';
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50">
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 w-96 h-[500px] flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-emerald-500 to-lime-400 text-white p-4 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold">ติดต่อเจ้าหน้าที่</h3>
                <p className="text-sm text-white/80">เราพร้อมช่วยเหลือคุณ</p>
              </div>
            </div>
            <button
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {isLoading ? (
            ...
            <div className="text-center text-gray-500 py-8">
              ...
              <p>เริ่มต้นการสนทนากับเจ้าหน้าที่</p>
                ...
                >
                  ...
                  >
                    <div className="text-sm font-medium mb-1">
                      {message.senderRole === 'customer' ? 'คุณ' : 'เจ้าหน้าที่'}
                    </div>
